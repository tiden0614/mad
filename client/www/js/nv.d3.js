...
nv.interactiveGuideline = function() {
	...
	var linecharts = $('svg:visible');

    for (var i = 0; i < linecharts.length; i++) {
        //if (linecharts[i].is(":visible")){
            linecharts[i].addEventListener('touchstart',function(e){ mapTouchEvents(e,'mousedown'); },true);
            linecharts[i].addEventListener('touchmove',function(e){ mapTouchEvents(e,'mousemove'); },true);
            linecharts[i].addEventListener('touchend',function(e){ mapTouchEvents(e,'mouseup'); },true);
            linecharts[i].addEventListener('touchcancel',function(e){ mapTouchEvents(e,'mouseup'); },true);
        //}
    //linecharts[i].attr("display")
